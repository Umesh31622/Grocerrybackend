...
/* ======================================================
      MIDNIGHT AUTO LOCK (ONLY AT 12:00 AM)
====================================================== */
async function runDailyLock() {
  const now = new Date();
  ...
  console.log("🌙 12AM Lock Updated:", today);
}


/* ======================================================
      CHECK TIME EVERY 1 MIN (BUT LOCK ONLY AT 12:00)
====================================================== */
setInterval(() => {
  const now = new Date();
...
/* ======================================================
      CONTROLLERS (FULL FUNCTIONALITY)
====================================================== */
